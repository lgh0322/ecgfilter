...
Java_com_viatom_myapplication_MainActivity_shortfilter(JNIEnv *env, jobject thiz, jshortArray inShorts) {
...
//Java_com_viatom_lib_bp_activity_BpMainActivity_offlineFilter(JNIEnv *env, jobject thiz, jdoubleArray doubles) {
//
//    double *doubleArray;
